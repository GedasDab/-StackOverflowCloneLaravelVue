                ...
                <div class="card-body">
                    <div class="card-title">
                        ...
                        @foreach ( $answers as $answer )
                            <div class="media">
                                <div class="d-frex flex-column vote-controls">

                            <a href="" title="This answer is useful" 
                            class="vote-up {{ Auth::guest() ? 'off' : '' }}"
                            onclick="event.preventDefault(); document.getElementById('up-vote-question-{{$answer->id}}').submit();">
                                <i class="fas fa-caret-up fa-3x"></i>
                            </a>
                            <form id="up-vote-question-{{$answer->id}}" action="/answers/{{$answer->id}}/vote" method="POST" style="display:none;">
                                @csrf
                            ...
                            onclick="event.preventDefault(); document.getElementById('down-vote-question-{{$answer->id}}').submit();">
                                ...
                                <form id="down-vote-question-{{$answer->id}}" action="/answers/{{$answer->id}}/vote" method="POST" style="display:none;">
                                @csrf
                                <input type="hidden" name="vote" value="-1">
                            </form>
